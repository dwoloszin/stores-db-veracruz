"""
scraper_indiana.py — Scraper for Farmacia Indiana (https://www.farmaciaindiana.com.br)
...
Usage:
    python -m markets.paguemenos.scraper_indiana              # scrape -> DB
    python -m markets.paguemenos.scraper_indiana --limit 500  # test run -> DB
    python -m markets.paguemenos.scraper_indiana --csv        # scrape -> DB + CSV
"""
...
BASE_URL  = "https://www.farmaciaindiana.com.br"
STORE_ID  = "indiana"
...
_SKIP_IDS: set = set()   # no SEM CATEGORIA dept; tiny junk cats (Outras/z_INBOX) add only a few
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape Farmacia Indiana -> PostgreSQL (DB is always written; CSV is optional)"
    )
    ...
    from db.db_manager import IndianaDB, load_env
    load_env(args.env)
