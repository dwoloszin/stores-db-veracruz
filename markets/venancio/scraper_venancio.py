"""
scraper_venancio.py — Scraper for Drogaria Venâncio (https://www.drogariavenancio.com.br)
...
Usage:
    python -m markets.paguemenos.scraper_venancio              # scrape -> DB
    python -m markets.paguemenos.scraper_venancio --limit 500  # test run -> DB
    python -m markets.paguemenos.scraper_venancio --csv        # scrape -> DB + CSV
"""
...
BASE_URL  = "https://www.drogariavenancio.com.br"
STORE_ID  = "venancio"
...
_SKIP_IDS: set = set()   # Venâncio has no empty SEM CATEGORIA dept (id=1 is Higiene)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape Drogaria Venâncio -> PostgreSQL (DB is always written; CSV is optional)"
    )
    ...
    from db.db_manager import VenancioDB, load_env
    load_env(args.env)
