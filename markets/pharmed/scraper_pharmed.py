"""
scraper_pharmed.py — Scraper for Pharmed (https://www.pharmed.com.br)

Platform   : WordPress + WooCommerce (specialty / high-cost medications).
Data source : Public WooCommerce Store API
                https://www.pharmed.com.br/wp-json/wc/store/v1/products?per_page=100&page=N
...
EAN        : Not in the API. Lives on each product page under the (mislabeled)
             ...
             GTIN-13. Populated by enrich_ean_pharmed.py after scraping.

Usage:
    python -m markets.pharmed.scraper_pharmed              # scrape -> DB
    python -m markets.pharmed.scraper_pharmed --limit 100  # test run -> DB
    python -m markets.pharmed.scraper_pharmed --csv        # scrape -> DB + CSV
"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape Pharmed (pharmed.com.br) -> PostgreSQL (DB always written; CSV optional)"
    )
    ...
    from db.db_manager import PharmedDB, load_env
    load_env(args.env)
