"""
enrich_ean_facilita.py — Backfill EAN/barcode for Facilita Medicamentos products.
...
Usage:
    python -m markets.facilita.enrich_ean_facilita
    python -m markets.facilita.enrich_ean_facilita --limit 100
    python -m markets.facilita.enrich_ean_facilita --workers 12
"""
...
def enrich(workers: int = 12, limit: Optional[int] = None, db=None) -> Dict[str, int]:
    from db.db_manager import FacilitaDB
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Backfill EAN for Facilita Medicamentos products")
