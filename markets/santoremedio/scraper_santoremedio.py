"""
scraper_santoremedio.py — Scraper for Santo Remédio (https://www.santoremedio.com.br)
...
Discovery : sitemap index /sitemap/index -> /sitemap/products/1..N (100 URLs each,
            ~215 sitemaps, ~21.4k products). Product URL: /{mpn}-{slug}-p{sku}.
...
Usage:
    python -m markets.santoremedio.scraper_santoremedio              # scrape -> DB
    python -m markets.santoremedio.scraper_santoremedio --limit 300  # test run -> DB
"""
...
BASE_URL     = "https://www.santoremedio.com.br"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Scrape Santo Remédio -> PostgreSQL")
    ...
    from db.db_manager import SantoRemedioDB, load_env
    load_env(args.env)
