"""
scraper_oncoexpresso.py — Scraper for Onco Expresso (https://oncoexpresso.com.br)
...
Usage:
    python -m markets.oncoexpresso.scraper_oncoexpresso              # scrape -> DB
    python -m markets.oncoexpresso.scraper_oncoexpresso --limit 200  # test run -> DB
    python -m markets.oncoexpresso.scraper_oncoexpresso --csv        # scrape -> DB + CSV
"""
...
BASE_URL   = "https://oncoexpresso.com.br"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape Onco Expresso -> PostgreSQL (DB is always written; CSV is optional)"
    )
    ...
    from db.db_manager import OncoexpressoDB, load_env
    load_env(args.env)
