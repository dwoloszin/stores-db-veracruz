"""
scraper_drogal.py — Scraper for Drogal (https://www.drogal.com.br)
...
Usage:
    python -m markets.paguemenos.scraper_drogal              # scrape -> DB
    python -m markets.paguemenos.scraper_drogal --limit 500  # test run -> DB
    python -m markets.paguemenos.scraper_drogal --csv        # scrape -> DB + CSV
"""
...
BASE_URL  = "https://www.drogal.com.br"
STORE_ID  = "drogal"
...
_SKIP_IDS: set = set()   # Drogal has no empty SEM CATEGORIA dept (id=1 is Barbear)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape Drogal -> PostgreSQL (DB is always written; CSV is optional)"
    )
    ...
    from db.db_manager import DrogalDB, load_env
    load_env(args.env)
