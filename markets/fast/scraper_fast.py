"""
scraper_fast.py — Scraper for Fast Medicamentos (https://www.fastmedicamentos.com.br)
...
Usage:
    python -m markets.fast.scraper_fast              # scrape -> DB
    python -m markets.fast.scraper_fast --limit 100  # test run -> DB
    python -m markets.fast.scraper_fast --csv        # scrape -> DB + CSV
"""
...
BASE_URL   = "https://www.fastmedicamentos.com.br"
STORE_ID   = "fast"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape Fast Medicamentos -> PostgreSQL (DB is always written; CSV is optional)"
    )
    ...
    from db.db_manager import FastDB, load_env
    load_env(args.env)
