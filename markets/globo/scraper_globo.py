"""
scraper_globo.py — Scraper for Drogaria Globo (https://www.drogariaglobo.com.br)
...
Usage:
    python -m markets.paguemenos.scraper_globo              # scrape -> DB
    python -m markets.paguemenos.scraper_globo --limit 500  # test run -> DB
    python -m markets.paguemenos.scraper_globo --csv        # scrape -> DB + CSV
"""
...
BASE_URL  = "https://www.drogariaglobo.com.br"
STORE_ID  = "globo"
...
_SKIP_IDS: set = set()   # id=1 is a real dept (Saúde); walk all leaves
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape Drogaria Globo -> PostgreSQL (DB is always written; CSV is optional)"
    )
    ...
    from db.db_manager import GloboDB, load_env
    load_env(args.env)
