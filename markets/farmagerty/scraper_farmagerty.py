"""
scraper_farmagerty.py — Scraper for Farmagerty (https://www.farmagerty.com.br)

Platform  : Tray / CommerceSuite (Wake) — images.tcdn.com.br
API       : /web_api/products  (public Tray Web API, JSON, no auth for reads)
Pagination: ?limit=50&page=N  (maxLimit 50); paging.total gives the count (~618)
...
Usage:
    python -m markets.remed.scraper_farmagerty              # scrape -> DB
    python -m markets.remed.scraper_farmagerty --limit 100  # test run -> DB
    python -m markets.remed.scraper_farmagerty --csv        # scrape -> DB + CSV
"""
...
BASE_URL   = "https://www.farmagerty.com.br"
STORE_ID   = "farmagerty"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape Farmagerty -> PostgreSQL (DB always written; CSV optional)"
    )
    ...
    from db.db_manager import FarmagertyDB, load_env
    load_env(args.env)
