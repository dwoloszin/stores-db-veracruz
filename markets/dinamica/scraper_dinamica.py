"""
scraper_dinamica.py — Scraper for Dinâmica Drogaria (https://www.dinamicadrogaria.com.br)

Platform   : WordPress + WooCommerce (specialty / high-cost medications).
Data source : Public WooCommerce Store API
                https://www.dinamicadrogaria.com.br/wp-json/wc/store/v1/products?per_page=100&page=N
...
EAN        : Not in the API. Lives on each product page under the (mislabeled)
             ...
             GTIN-13. Populated by enrich_ean_dinamica.py after scraping.

Usage:
    python -m markets.dinamica.scraper_dinamica              # scrape -> DB
    python -m markets.dinamica.scraper_dinamica --limit 100  # test run -> DB
    python -m markets.dinamica.scraper_dinamica --csv        # scrape -> DB + CSV
"""
...
BASE_URL  = "https://www.dinamicadrogaria.com.br"
STORE_ID  = "dinamica"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape Dinâmica Drogaria (dinamicadrogaria.com.br) -> PostgreSQL (DB always written; CSV optional)"
    )
    ...
    from db.db_manager import DinamicaDB, load_env
    load_env(args.env)
