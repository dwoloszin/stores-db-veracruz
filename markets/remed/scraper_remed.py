"""
scraper_remed.py — Scraper for Remed (https://www.remed.com.br)
...
Usage:
    python -m markets.remed.scraper_remed              # scrape -> DB
    python -m markets.remed.scraper_remed --limit 100  # test run -> DB
    python -m markets.remed.scraper_remed --csv        # scrape -> DB + CSV
"""
...
BASE_URL   = "https://www.remed.com.br"
STORE_ID   = "remed"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape Remed -> PostgreSQL (DB always written; CSV optional)"
    )
    ...
    from db.db_manager import RemedDB, load_env
    load_env(args.env)
