"""
scraper_santalucia.py — Scraper for Santa Lucia Drogarias (https://www.santaluciadrogarias.com.br)
...
Usage:
    python -m markets.paguemenos.scraper_santalucia              # scrape -> DB
    python -m markets.paguemenos.scraper_santalucia --limit 500  # test run -> DB
    python -m markets.paguemenos.scraper_santalucia --csv        # scrape -> DB + CSV
"""
...
BASE_URL  = "https://www.santaluciadrogarias.com.br"
STORE_ID  = "santalucia"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape Santa Lucia Drogarias -> PostgreSQL (DB is always written; CSV is optional)"
    )
    ...
    from db.db_manager import SantaLuciaDB, load_env
    load_env(args.env)
