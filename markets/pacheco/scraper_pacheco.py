"""
scraper_pacheco.py — Scraper for Drogaria Pacheco (https://www.drogariaspacheco.com.br)
...
Usage:
    python -m markets.pacheco.scraper_pacheco              # scrape -> DB
    python -m markets.pacheco.scraper_pacheco --limit 500  # test run -> DB
    python -m markets.pacheco.scraper_pacheco --csv        # scrape -> DB + CSV
"""
...
if __name__ == "__main__":
    ...
    from db.db_manager import PachecoDB, load_env
    load_env(args.env)
