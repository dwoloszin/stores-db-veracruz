"""
scraper_diabetescenter.py — Scraper for Diabetes Center (https://www.diabetescenter.com.br)

Platform  : Tray / CommerceSuite (Wake) — images.tcdn.com.br
API       : /web_api/products  (public Tray Web API, JSON, no auth for reads)
Pagination: ?limit=50&page=N  (maxLimit 50); paging.total gives the count (~816)
...
Usage:
    python -m markets.diabetescenter.scraper_diabetescenter              # scrape -> DB
    python -m markets.diabetescenter.scraper_diabetescenter --limit 100  # test run -> DB
    python -m markets.diabetescenter.scraper_diabetescenter --csv        # scrape -> DB + CSV
"""
...
BASE_URL   = "https://www.diabetescenter.com.br"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape Diabetes Center -> PostgreSQL (DB always written; CSV optional)"
    )
    ...
    from db.db_manager import DiabetesCenterDB, load_env
    load_env(args.env)
