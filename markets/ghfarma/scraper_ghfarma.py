"""
scraper_ghfarma.py — Scraper for GH Farma (https://www.ghfarma.com.br)

Platform   : Tray Commerce (Brazilian e-commerce platform).
Data source : Public Tray Store API
                https://www.ghfarma.com.br/web_api/products?limit=50&page=N
...
EAN        : First-class API field ("ean"), ~89% coverage — no enrichment needed.
Prices     : "price" / "promotional_price" are decimal strings in BRL.
             promotional_price == "0" means no active promotion.

Usage:
    python -m markets.ghfarma.scraper_ghfarma              # scrape -> DB
    python -m markets.ghfarma.scraper_ghfarma --limit 200  # test run -> DB
    python -m markets.ghfarma.scraper_ghfarma --csv        # scrape -> DB + CSV
"""
...
BASE_URL  = "https://www.ghfarma.com.br"
STORE_ID  = "ghfarma"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Scrape GH Farma (ghfarma.com.br) -> PostgreSQL (DB always written; CSV optional)"
    )
    ...
    from db.db_manager import GhfarmaDB, load_env
    load_env(args.env)
