...
"""
enrich_ean_farmaconde.py - Backfill EAN/barcode for Farmaconde products.

Farmaconde listing/API may miss EAN for some SKUs. This backfill fetches
product detail pages and extracts barcode from embedded __NEXT_DATA__.

Usage:
    python -m markets.farmaconde.enrich_ean_farmaconde
    python -m markets.farmaconde.enrich_ean_farmaconde --limit 500
    python -m markets.farmaconde.enrich_ean_farmaconde --workers 20
"""
...
def enrich(workers: int = 12, limit: Optional[int] = None, db=None) -> Dict[str, int]:
    from db.db_manager import FarmacondeDB
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Backfill EAN for Farmaconde products")
